...
//   ),
//     required String automatic_payment_methods[allow_redirects],
//     List<Map<String, dynamic>>? items,
//   }) async {
//     final url = Uri.parse(
//       'https://us-central1-carpooling-mobile-app.cloudfunctions.net/StripePayEndpointMethodId',
//     );
...
//   }) async {
//     final url = Uri.parse(
//       'https://us-central1-carpooling-mobile-app.cloudfunctions.net/StripePayEndpointIntentId',
//     );
//     final response = await http.post(
//       url,
//       headers: {'Content-Type': 'application/json'},
